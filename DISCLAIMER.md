...
**This software is provided for research, educational, and personal use only.**

By using, modifying, or distributing this software, you agree to the terms below. If you do not agree, do not use this software.

---

## No warranty

This software is provided "as is" without warranty of any kind, express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, or non-infringement. The entire risk as to the quality and performance of the software is with you.

The authors and contributors make no representations about the suitability of this software for any purpose. This software may contain bugs, vulnerabilities, or unintended behaviors. It has not been independently audited, certified, or approved by any regulatory body.
...
This software provides capabilities for signal intelligence, RF analysis, spectrum monitoring, mesh networking, and communications sovereignty. These capabilities can be used for legitimate security research, defensive operations, amateur radio, operational awareness, and personal privacy, but could theoretically be misused.

Specific capabilities include:

- Software-defined radio (SDR) control and signal processing
- Spectrum analysis and anomaly detection
- Radio programming (amateur, GMRS, commercial handhelds)
- Mesh networking over LoRa (Meshtastic protocol)
- Cellular tower analysis and IMSI catcher detection
- WiFi and Bluetooth monitoring for surveillance detection
- Network intrusion detection and response
- OSINT collection and correlation

The authors provide these capabilities for research, education, operational security, amateur radio, and personal use. The authors do not endorse, encourage, or authorize any unlawful use.

---

## No authorization or endorsement
...
To the maximum extent permitted by applicable law, the authors and contributors shall not be liable for any direct, indirect, incidental, special, consequential, or exemplary damages arising out of or in connection with this software, including but not limited to:

- Loss of data, hardware damage, or service interruption
- Legal consequences to the user from their use of the software
- Any action taken by third parties who obtained the software from the user
- Any other damages, regardless of the cause or theory of liability
...
This disclaimer is not legal advice. If you have specific questions about whether your intended use of this software is lawful in your jurisdiction, consult a qualified attorney.
